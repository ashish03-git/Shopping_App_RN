            ...
            <View style={styles.container}>
                <PanGestureHandler onGestureEvent={panGesture}>
                    <Animated.View style={[styles.login, animatedStyles]}>
                        ...
                        <TextInput style={styles.input} onChangeText={(text) => setEmail(text)} placeholder='Enter Your Name' />

                        <TextInput style={styles.input} onChangeText={(text) => setPassword(text)} placeholder='Enter Your Email' />
                        <TextInput style={styles.input} onChangeText={(text) => setPassword(text)} placeholder='Create Password' />
                        <TextInput style={styles.input} onChangeText={(text) => setPassword(text)} placeholder='Confirm Password' />
                        <TextInput style={styles.input} onChangeText={(text) => setPassword(text)} placeholder='Enter Your Number' />
                        ...
                        <View style={{ justifyContent: "center", alignItems: "center" }}>
                            ...
                            <Text style={{ color: "black", fontSize: 15, marginTop: 10 }}>If already registered ?</Text>
                            <TouchableOpacity onPress={() => {
                                props.navigation.navigate("Login")
                            }}>
                                <Text style={{ color: "blue", fontSize: 15 }}>click to login</Text>
                            </TouchableOpacity>
                        </View>
